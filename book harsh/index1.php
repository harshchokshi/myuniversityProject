...
require_once('header.php') ;
	 ...
	 if (isset($_POST[ 'submit'])){
		    ...
		    extract($_POST);
		    $image_name = basename($_FILES["fileToUpload"]["name"]); // store seller profile images
		    $seller_name = $_POST['seller_name']; // store seller name
		 	$seller_email = $_POST['seller_email']; // store email address
			$seller_phone = $_POST['seller_phone']; // store phone number
			$seller_password =  md5($_POST['seller_password']); // store password
								
			$query11 = "SELECT * FROM seller WHERE seller_name='$seller_name'";
			...
			$query = "INSERT INTO seller(seller_id, seller_name, seller_email, seller_phone, seller_image, seller_password) VALUES ('', '$seller_name', '$seller_email', $seller_phone, '$image_name', '$seller_password')";
			$result = mysqli_query($db,$query) ;
			
$target_dir = "uploads/seller/";
 ...
 <section class="banner_area">
        <!-- Content Wrapper -->
                    ...
                    <div class="toma top-margin width-70">
                               ...
                               <form action="<?php echo $site_url;?>/index1.php" method="post" class="form-horizontal" enctype="multipart/form-data" id="loginForm">
            
                                    
                              <div class="col-md-6">
                                        <div>
                                            <label class="control-label" for="username">Name</label>
                                            <input type="text" required value="" name="seller_name" class="form-control">            
                                        </div>
                                        
                                        <div>
                                            <label class="control-label" for="username">Email</label>
                                            <input type="email" required value="" name="seller_email" class="form-control">            
                                        </div>
                                        
                                        <div>
                                            <label class="control-label" for="username">Phone</label>
                                            <input type="tel" required value="" name="seller_phone" class="form-control">            
                                        </div>
                               ...
                               <div class="col-md-6">
                                       ...
                                       <div>
                                        ...
                                        <div>
                                            ...
                                            <input type="password" placeholder="******" id="txtPassword" required value="" name="seller_password" class="form-control">
                                        </div>
                                        
                                        <div>
                                            <label class="control-label" for="operator_password">Confirm Password</label>
                                            <input type="password" placeholder="******" id="txtCPassword" required value="" name="seller_password" class="form-control" onkeyup="checkPasswordMatch();">
