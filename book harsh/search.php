                                ...
                                <div class="col-md-12 col-sm-12">
                                      ...
                                      <?php 
									   ...
									   if(isset($_SESSION["seller_email"]) != ''){
									       ...
									       $query1 = "SELECT * FROM item WHERE seller_id = $seller_id && item_name like '%".$search."%' ORDER BY item_name ASC";
										   ...
										   ?>
                                                ...
                                                <div class="col-md-4 col-sm-4 toma-no-padding" style=" padding-left:15px;">
                                                       ...
                                                       <a href="<?php echo $site_url;?>/item_details.php/<?php echo $post1->item_id;?>"><img src="<?php echo $site_url;?>/uploads/item/<?php echo $post1->item_image;?>" width="298px" height="220px">                                        <h4><?php echo $post1->item_name;?></h4></a>
                                                ...
                                                if(isset($_SESSION["buyer_email"]) != '')
												   {
													   ...
													   $query10 = "SELECT * FROM item WHERE  item_name like '%".$search."%'  ORDER BY item_name ASC";
										   ...
										   ?>
                                              ...
                                              <!-- <form action="<?php echo $_SERVER['REQUEST_URI'];?>" method="post" enctype="multipart/form-data">-->
                                                <div class="col-md-4 col-sm-4 toma-no-padding" style=" padding-left:15px;">
                                                   ...
                                                   <a href="<?php echo $site_url;?>/item_details.php/<?php echo $post10->item_id;?>"><img src="<?php echo $site_url;?>/uploads/item/<?php echo $post10->item_image;?>" width="298px" height="220px">                                    <h4><?php echo $post10->item_name;?></h4></a>
                                                   <h6 class="price">AUD  <?php echo $post10->item_price;?><a href="#" class="buy">Buy Now</a></h6>
                                                    ...
                                                    <?php
												     ...
												     if(isset($_SESSION["buyer_email"]) == '' && isset($_SESSION["seller_email"]) == '')
												   {
										   ...
										   ?>
                                              ...
                                              <!-- <form action="<?php echo $_SERVER['REQUEST_URI'];?>" method="post" enctype="multipart/form-data">-->
                                                <div class="col-md-4 col-sm-4 toma-no-padding" style=" padding-left:15px;">
                                                  ...
                                                  <img src="<?php echo $site_url;?>/uploads/item/<?php echo $post10->item_image;?>" width="298px" height="220px">                                    <h4><?php echo $post10->item_name;?></h4>
